...
* Examine other unsupervised techniques to detect anomalies
  * Clustering, for example, can be used solely or together with AE (by manipulating the reconstruction target of each instance to be the center of its cluster)
