...
1. <img align="right" img src="images/shingle.png" alt="alt text" width="180" height="180"> Use *shingle()* to create the data set and the labels set. Each data point consists of k-consecutive values of the time series,
